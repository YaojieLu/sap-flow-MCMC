...
axs[0].set(ylim=(-4, 0))
axs[0].legend(title_fontsize=30, bbox_to_anchor=(1.07, 1.13), ncol=4)
...
axs[1].text(0, -0.2, 'b) literature')
fig.subplots_adjust(wspace=0.02)
# fig.savefig('../../Figures/p50.png', bbox_inches='tight')
# print(df.groupby('species_code')['p50'].agg(['mean', 'std'])\
