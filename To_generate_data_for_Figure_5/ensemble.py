...
def f1(species_code, T, I, D, ps, observed, date, Vcmax, Jmax):
    # read trace
    ts = pickle.load(open('../../Data/UMB_trace/Gil_v2/final/{}.pickle'\
...
for species_code in species_codes:
    if os.path.exists('../../Results/final/ensemble_vn_UMB_Gil_v2_{}.csv'\
                      .format(species_code)):
    ...
    try:
        ...
        continue
    vn.to_csv('../../Results/final/ensemble_vn_UMB_Gil_v2_{}.csv'\
              .format(species_code), index=False)
    PLC.to_csv('../../Results/final/ensemble_PLC_UMB_Gil_v2_{}.csv'\
               .format(species_code), index=False)
    gs.to_csv('../../Results/final/ensemble_gs_UMB_Gil_v2_{}.csv'\
              .format(species_code), index=False)
